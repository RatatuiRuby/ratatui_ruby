  ...
  class TestCalendar < Minitest::Test
    ...
    def test_calendar_rendering
      ...
      with_test_terminal(22, 7) do
        ...
        RatatuiRuby.draw(calendar)

        assert_equal "    December 2025     ", buffer_content[0]
        assert_equal " Su Mo Tu We Th Fr Sa ", buffer_content[1]
        assert_equal "     1  2  3  4  5  6 ", buffer_content[2]
        assert_equal "  7  8  9 10 11 12 13 ", buffer_content[3]
        assert_equal " 14 15 16 17 18 19 20 ", buffer_content[4]
        assert_equal " 21 22 23 24 25 26 27 ", buffer_content[5]
        assert_equal " 28 29 30 31          ", buffer_content[6]
      end
    end
